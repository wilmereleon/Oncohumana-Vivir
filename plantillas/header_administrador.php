...
<body>
  <nav class="navbar navbar-expand navbar-light bg-light">
      <div class="nav navbar-nav">
          ...
          <a class="nav-item nav-link" href="#">Creación de usuarios</a>
          <a class="nav-item nav-link" href="../secciones/vista_administrador_modificar.php">Modificar datos de paciente</a>
